...
save(ames, file = "../datas/ames.RData")
```
...
save(ames_split, ames_train, ames_test, file = "../datas/ames_train_test.RData")
```
...
rm(list = ls())
load("../datas/ames_train_test.RData")
```
